...
var stats = Data_Map.fromList(Prelude.ordString)(Prelude["<$>"](Data_List.functorList)(function (pbs) {
    return new Data_Tuple.Tuple(pbs.label, pbs);
})(Data_List.toList(Data_Foldable.foldableArray)($foreign.statistics)));
var stat2 = {
    matches: 40.0, 
    label: "Last 40", 
    winPercentage: "80", 
    ...
    return function (__dict_Alternative_1) {
        ...
        var markupPlayer = function (player) {
            return function (winner) {
                var _43 = Prelude["=="](Prelude.eqString)(player)(winner);
                if (_43) {
                ...
                throw new Error("Failed pattern match at Main line 150, column 1 - line 151, column 1: " + [ _43.constructor.name ]);
            };
        };
...
var appendToWrapper = function (e) {
    return function __do() {
        ...
        throw new Error("Failed pattern match at Main line 44, column 1 - line 45, column 1: " + [ _0.constructor.name ]);
    };
};
